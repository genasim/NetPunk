...
ANetGameCharacter::ANetGameCharacter()
{
...
void ANetGameCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ANetGameCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void ANetGameCharacter::MoveForward(float Value)
{
...
void ANetGameCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
